...
@section("header-content")
    ...
    <div class="row mx ">
        <div class="col-12">
            <h1 class="text-start">Register: Become Event Manager</h1>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row mx-0 d-flex flex-row justify-content-center">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 px-3">
                    ...
                    <form action="{{ route('eo.register') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <div class="row mx-0">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-0 pe-md-2 pe-lg-2">
                                <div class="form-group ">
                                    ...
                                    <input name="country" id="country" class="form-control @error('country') is-invalid @enderror" value="Pakistan">
                        ...
                        <div class="row mx-0 mt-3">
                            <div class="col-12 p-0 text-end">
                                ...
                                <div class="d-flex flex-row">
                                    <p>Already have an account! <a href="{{route("eo.login")}}">Login</a></p>
                                </div>
...
<script>
    ...
    {{--        });--}}
    {{--    }).fail(function(){--}}
    {{--        $("#err").append("<p class='text-danger'>OOPs! something went wrong while loading country's data,please try again</p>")--}}
    {{--        setTimeout(function(){--}}
    {{--            $("#err > p").remove();--}}
    {{--        },4000)--}}
    {{--    });--}}
