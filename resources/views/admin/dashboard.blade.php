    ...
    <div class="container-fluid p-0">
        ...
        @endif
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Welcome</strong>{{Auth::guard('admin')->user()->name}}.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        <h1 class="h3 mb-3"><strong>EMS</strong> Analytics Dashboard</h1>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">Total Registered Event Organizers</h5>
                                        </div>
                                    ...
                                    <h1 class="mt-1 mb-3">{{$eos_count}}</h1>
                                    <div class="mb-0">
                                        <span class="text-success"> <i class="mdi mdi-arrow-bottom-right"></i> {{$eos_registered_in_last_week}} </span>
                                        <span class="text-muted">Registered last week</span>
                                    </div>
                                </div>
                            </div>
                        </div>
