        ...
        <div class="row mx-0">
            <div class="col-12">
                @if($errors->any())
                    ...
                    @endforeach
                @endif
                <form action="{{route("admin.eo_profiles.update",$eo->id)}}" method="post">
                    @csrf
                    @method('PUT')

                    <div class="form-group mt-2">
                        <label for="">Name</label>
                        <input id="name" type="text" value="{{old("name",$eo->name)}}" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input id="email" type="email" value="{{old("email",$eo->email)}}" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                    ...
                    <div class="row mx-0 mt-3">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-0 pe-md-2 pe-lg-2">
                            <div class="form-group ">
                                ...
                                <input type="text" name="country" id="country" value="{{old('country',$eo->country)}}" class="form-control" />
                                @error('country')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 p-0 ps-md-2 ps-lg-2">
                            <div class="form-group ">
                                ...
                                <select name="city" id="city" data-old_value="{{$eo->city}}" class="form-select">
